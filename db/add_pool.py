def main(con, table, net,
         ...
         token2_symbol):
    try:
        sql = f'INSERT INTO {table} (net, net_short, net_extra, pool_main_contract, pool_address, time_created,token1_address,token1_symbol,token2_address,token2_symbol) values(?,?,?,?,?,?,?,?,?,?);'
